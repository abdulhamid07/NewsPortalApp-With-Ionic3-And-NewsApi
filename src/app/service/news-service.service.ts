...
export class NewsServiceService {
  ...
  private HEADLINE_API = "https://newsapi.org/v2/top-headlines?country=id";
  private EVERYTHING_API = "https://newsapi.org/v2/everything?country=id";
  currentArticle: any;
  ...
  getNewsByTitle(title: string, page: any) {
    let params = new HttpParams();
    params = params
      .set("page", page)
      .set("country", "in")
